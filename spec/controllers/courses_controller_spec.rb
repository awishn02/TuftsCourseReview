...
describe CoursesController do
  ...
  let(:valid_attributes) { { "department_id" => "" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved course as @course" do
        ...
        post :create, {:course => { "department_id" => "invalid value" }}, valid_session
        expect(assigns(:course)).to be_a_new(Course)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested course" do
        ...
        expect_any_instance_of(Course).to receive(:update).with({ "department_id" => "" })
        put :update, {:id => course.to_param, :course => { "department_id" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the course as @course" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        allow_any_instance_of(Course).to receive(:save).and_return(false)
        put :update, {:id => course.to_param, :course => { "department_id" => "invalid value" }}, valid_session
        expect(assigns(:course)).to eq(course)
      end

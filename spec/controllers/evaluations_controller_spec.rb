...
describe EvaluationsController do
  ...
  let(:valid_attributes) { { "course_id" => "" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved evaluation as @evaluation" do
        ...
        post :create, {:evaluation => { "course_id" => "invalid value" }}, valid_session
        expect(assigns(:evaluation)).to be_a_new(Evaluation)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested evaluation" do
        ...
        expect_any_instance_of(Evaluation).to receive(:update).with({ "course_id" => "" })
        put :update, {:id => evaluation.to_param, :evaluation => { "course_id" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the evaluation as @evaluation" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        allow_any_instance_of(Evaluation).to receive(:save).and_return(false)
        put :update, {:id => evaluation.to_param, :evaluation => { "course_id" => "invalid value" }}, valid_session
        expect(assigns(:evaluation)).to eq(evaluation)
      end
